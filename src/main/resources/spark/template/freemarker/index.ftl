...
<head>
  ...
  <script src="/scripts/jquery.ui.map.rdfa.js"></script>
  <script src="/scripts/jquery.ui.map.overlays.js"></script>
  <script src="/scripts/jquery.ui.map.microformat.js"></script>
  <script src="/scripts/jquery.ui.map.microdata.js"></script>
...
<body class="breakpoint-1024">
  ...
  <div class="st-container">
    ...
    <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><img src="/images/logo.png" height="66" width="54"/></a>
        </div>
          ...
          <ul class="nav navbar-nav  navbar-right ">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle user" data-toggle="dropdown">
                <img src="/images/guy-5.jpg" alt="Bill" class="img-circle" width="40"> Kemi <span class="caret"></span>
              </a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="#user-private-profile.html">Profile</a></li>
                <li><a href="#user-private-messages.html">Messages</a></li>
        ...
        <div class="st-content-inner">
          ...
          <nav class="navbar navbar-subnav navbar-static-top" role="navigation">
            <div class="container">
              ...
              <!-- Collect the nav links, forms, and other content for toggling -->
              <div class="collapse navbar-collapse" id="subnav" aria-expanded="true">
                <ul class="nav navbar-nav">
                  <li class="active">
                    <a href="index.html"><i class="fa fa-fw fa-clock-o"></i> My Timeline</a>
                  </li>
                  <li>
                    <a href="#user-private-profile.html"><i class="fa fa-fw fa-user"></i>Profile</a>
                  </li>
                  <li>
                    <a href="#user-private-users.html"><i class="fa fa-fw fa-group"></i>Friends</a>
                  </li>
                   <li>
				        <a href="#user-private-users.html"><i class="fa fa-fw fa-group"></i>Purse</a>
                  </li>
                  <li>
                    <a href="#user-private-messages.html"><i class="fa fa-fw fa-comment"></i>Messages</a>
                  </li>
                </ul>
                <ul class="nav navbar-nav hidden-xs navbar-right">
                  <li><a href="#login.html">Logout  <i class="fa fa-fw fa-unlock"></i></a></li>
                </ul>
              </div>
              <!-- /.navbar-collapse -->
            </div>
          ...
          <div class="container">
            ...
            <div class="cover profile">
              ...
              <div class="cover-info">
                ...
                <div class="name"><a href="#">Kemi Olowe</a></div>
                <ul class="cover-nav">
    ...
    <!-- Footer -->
    <footer class="footer">
      <a href="#">About</a>&nbsp;<a href="#">Mobile</a>&nbsp;<a href="#">Terms</a>&nbsp;<a href="#">Privacy</a>&nbsp;<a href="#">Quick links</a>&nbsp;<a href="#">Routes</a>&nbsp;<href="#">  Help</a> -
...
<script type="text/javascript" src="/scripts"></script></body></html>