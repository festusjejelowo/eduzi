...
public class DbConnectionProvider implements ConnectionProvider {
	...
	public void configure(Properties props) throws HibernateException {
		try {
			log.debug("Configure DbConnectionProvider");
		...
		log.debug("Configure DbConnectionProvider complete");
	}
	...
	public void close() throws HibernateException {
		...
		log.debug("Close DbConnectionProvider");
		logStatistics();
		try {
			if (ds != null) {
				ds.close();
		...
		log.debug("Close DbConnectionProvider complete");
	}
